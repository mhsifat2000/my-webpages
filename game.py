...
track = pygame.image.load('/storage/emulated/0/Download/IMG_20240718_153545.png')
track= pygame.transform.scale(track,(1000,1200))
car = pygame.image.load('/storage/emulated/0/tesla.png')
